...
class MonthlyTopController extends GetxController {
  ...
  final RxInt _playingPage = (-1).obs;

  get playingPage => _playingPage.value;
  set playingPage(value) => _playingPage.value = value;
