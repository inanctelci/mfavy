...
import 'package:mfavymusic/controllers/mini_player/other_mini_player_controller.dart';
...
class OtherMiniPlayer extends StatelessWidget {
  OtherMiniPlayer({
    super.key,
  });
  ...
  Widget regularPlayButtons(OtherMiniPlayerController miniPlayerController) {
  ...
  Widget playlistPlayButtons(OtherMiniPlayerController miniPlayerController) {
    switch (miniPlayerController.playerState) {
      case PlayerState.playing:
        return Row(
