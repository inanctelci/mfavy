...
class MonthlyTop extends StatelessWidget {
  ...
  MonthlyTopController monthlyController = Get.find<MonthlyTopController>();
          ...
          builder: (getContext) {
            return Obx(() {
              return FutureBuilder<TopRatedSongsModel>(
                  future: TopService().getMonthlyTopList(3, monthlyController.dropDownValue),
                                    ...
                                    return !snapshot.hasData
                                        ...
                                        : Obx(() {
                                            return SongCard(
                                              ...
                                              index: monthlyController.dropDownValue == 1 ? index : -1,
                                              ...
                                              onTap: () {
                                                monthlyController.tappedSoundIndex = index;
                                                monthlyController.playingPage = monthlyController.dropDownValue;
                                                monthlyController.tappedVideoIndex = -1;
                                              ...
                                              widget: monthlyController.tappedVideoIndex == index
                                                  ...
                                                  : GestureDetector(
                                                      onTap: () {
                                                        ...
                                                        monthlyController.tappedVideoIndex = index;
                                                        monthlyController.tappedSoundIndex = -1;
                                                      },
                                                      child: Container(
                                              ...
                                              playButton: monthlyController.tappedSoundIndex == index &&
                                                      monthlyController.playingPage == monthlyController.dropDownValue
                                                  ? regularPlayButtons(miniPlayerController)
                                                  : null,
                                              backGroundIndicator:
                                                  (monthlyController.tappedSoundIndex == index || monthlyController.tappedVideoIndex == index) &&
                                                          monthlyController.playingPage == monthlyController.dropDownValue
                                                      ? Container(
        ...
        child: Row(
          ...
          children: [
            snapshot.data!.data[0].result!.pagination!.previousPage == null
                ...
                : GestureDetector(
                    onTap: () {
                      monthlyController.dropDownValue -= 1;
              ...
              child: Center(
                child: Obx(() {
                  return DropdownButton<int>(
                    value: monthlyController.dropDownValue,
                    ...
                    onChanged: ((value) {
                      monthlyController.dropDownValue = value;
